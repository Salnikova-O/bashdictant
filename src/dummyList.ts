...
export const dummyDictant = {
    ...
    "Tut -- tut -- tut -- sanctimoniuosness and stock phrases! Old phrasses and old gestures. The old lies and formal prostratoins. We know all about them. "`,
    markers: [{
        text: 'asdasd',
        position: 1
    }]
